...
/**
 * Describes a connection state transition on the CopilotClient.
 * Emitted whenever the client moves between connection states.
 */
export interface ConnectionStateChange {
    /** The state the client was in before the transition */
    previousState: ConnectionState;
    /** The state the client is now in */
    currentState: ConnectionState;
    /** Human-readable reason for the transition (e.g., "process_exited", "reconnecting") */
    reason?: string;
 ...
 */
export type ConnectionStateHandler = (change: ConnectionStateChange) => void;
/**
